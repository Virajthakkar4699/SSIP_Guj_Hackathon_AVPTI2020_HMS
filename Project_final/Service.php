    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container" >
        <ul class="nav-menu">
            ...
            <li class="menu-active"><a href="Service.php"><i class="ion-ios-checkmark"></i> Services</a></li>
      ...
      <div class="container">
        ...
        <header class="section-header wow fadeInUp">
            ...
            <br>
          <h3>Services</h3>
          <p><strong>These are the Services provided in our Hostel</strong></p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <h4 class="title"><a href="IndoorGames.php">Indoor Games</a></h4>
            
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-body"></i></div>
            <h4 class="title"><a href="Gymnasium.php">Gymnasium</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            ...
            <h4 class="title"><a href="Wifi.php">Wi-Fi Accessibility</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-nutrition-outline"></i></div>
            <h4 class="title"><a href="Canteen.php">Canteen</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-flame-outline"></i></div>
            <h4 class="title"><a href="EmergencySafety.php">Emergency Safeties</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-wineglass-outline"></i></div>
            <h4 class="title"><a href="Festivals.php">Festival Celebration</a></h4>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-bolt-outline"></i></div>
            <h4 class="title"><a href="Electricity.php">Electricity Supply</a></h4>
          </div>
         <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <div class="icon"><i class="ion-ios-clock-outline"></i></div>
            <h4 class="title"><a href="Maintenance.php">Timely Maintenance</a></h4>
          </div>
        </div>
