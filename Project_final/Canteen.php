    ...
    <section id="services">
        <div class="container">
            ...
            <header class="section-header wow fadeInUp">
                  ...
                  <br>
                <h3>Canteen</h3>
                <p><strong>A V Parekh Technical Institute has Canteen that provides Meal for Hostel Children.</strong></p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/canteen/canteen1.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/canteen/canteen2.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/canteen/canteen3.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
