        ...
        <header id="header" class="colour">
          <div class="container-fluid">
              ...
              <div id="logo" class="pull-left">
                <h1><a href="#" class="scrollto"> <i class="ion-ios-briefcase"></i> Hostel</a></h1>
              </div>
    ...
    <section id="services">
        <div class="container">
            ...
            <header class="section-header wow fadeInUp">
                ...
                <p><strong>A V Parekh Technical Institute provides Electricity for 24 x 7.</strong></p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Electricity/electricity1.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Electricity/electricity2.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Electricity/electricity3.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
