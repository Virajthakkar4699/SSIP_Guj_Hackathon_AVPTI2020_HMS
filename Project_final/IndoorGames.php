    ...
    <section id="services">
        <div class="container">
                ...
                <header class="section-header wow fadeInUp">
                  ...
                  <br>
                <h3>Indoor Games</h3>
                <p><strong>A V Parekh Technical Institute provides Indoor Gaming Facilities.</strong></p>
              </header>

            <div class="row">
                
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"> Carrom, Chess</h4>
                    <img src="images/IndoorGames/IndoorGame1.jpg" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"> Pool</h4>
                    <img src="images/IndoorGames/IndoorGame2.jpg"  class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"> Table Tennis</h4>
                    <img src="images/IndoorGames/IndoorGame3.jpg" class="thumbnail" height="300px" width="400px"/>
                </div>
            </div>
