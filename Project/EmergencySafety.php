    ...
    <section id="services">
        <div class="container">
            ...
            <header class="section-header wow fadeInUp">
                  ...
                  <br>
                  <br>
                <h3>Emergency Safeties</h3>
                <p><strong>A V Parekh Technical Institute has all the Safeties needed during Emergencies.</strong></p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/EmergencySafety/safety1.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/EmergencySafety/safety2.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/EmergencySafety/safety3.png" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
