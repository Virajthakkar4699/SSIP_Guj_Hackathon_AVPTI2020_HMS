    ...
    <section id="services">
        <div class="container">
                ...
                <header class="section-header wow fadeInUp">
                  ...
                  <br>
                <h3>Gymnasium</h3>
                <p><strong>A V Parekh Technical Institute provides Free Gymnasium for Fitness Freaker's.</strong></p>
              </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Gym/Gym1.jpeg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Gym/gym2.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Gym/Gym3.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
