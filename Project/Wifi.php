    ...
    <section id="services">
        <div class="container">
            ...
            <header class="section-header wow fadeInUp">
                  ...
                  <br>
                  <br>
                <h3>Wi-Fi Accessibility</h3>
                <p><strong>A V Parekh Technical Institute provides Free Internet facility for Students.</strong></p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Wifi/wifi1.png" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Wifi/wifi2.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/Wifi/wifi3.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
