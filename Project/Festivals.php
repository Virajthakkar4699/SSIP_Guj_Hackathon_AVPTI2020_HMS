    ...
    <section id="services">
        <div class="container">
            ...
            <header class="section-header wow fadeInUp">
                ...
                <p><strong>A V Parekh Technical Institute encourages Hostel Students to Celebrate Festivals of All Religions.</strong></p>
            </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/festival/festival1.jpg" alt="" class="thumbnail"height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/festival/festival2.jpg" alt="" class="thumbnail"height="300px" width="400px"/>
                </div>
                <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
                    <h4 class="title"></h4>
                    <img src="images/festival/festival3.jpg" alt="" class="thumbnail" height="300px" width="400px"/>
                </div>
