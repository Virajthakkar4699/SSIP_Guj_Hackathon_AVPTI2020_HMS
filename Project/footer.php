  ...
  <link href="css/style.css" rel="stylesheet">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
                <li><i class="ion-ios-arrow-right"></i> <a href="Welcome.php">Home</a></li>
                <li><i class="ion-ios-arrow-right"></i> <a href="NoticeBoard.php">Notice</a></li>
                <li><i class="ion-ios-arrow-right"></i> <a href="#">Penalties</a></li>
                <li><i class="ion-ios-arrow-right"></i> <a href="#">Complain Box</a></li>
                <li><i class="ion-ios-arrow-right"></i> <a href="#">Leave Request</a></li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong> +91 95865 72853,<br> +91 84605 16158<br>
              <strong>Email:</strong> 17bmiit015@gmail.com<br>
              17bmiit018@gmail.com <br>
            </p>
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by Harshit Kahar & Vaibhav Patel
      </div>
    </div>
  </footer>
