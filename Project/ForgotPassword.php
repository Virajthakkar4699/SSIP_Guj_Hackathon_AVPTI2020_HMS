...
<body>
	...
	<div class="w3ls-login box box--big wow fadeInUp">
		<!-- form starts here -->
                <form action="verifyforgot.php" method="post">
			...
			<div class="agile-field-txt">
				<label>
                                <span class="fa fa-lock" ></span> New Password </label>
				<input type="password" name="password1" placeholder="Enter New Password " required="true" id="input1"/>
                                <div class="agile_label">
					<input id="check3" name="check3" type="checkbox" value="show password" onclick="myFunction1()">
					<label class="check" for="check3">Show password</label>
				</div>
			</div>
			<div class="agile-field-txt">
				<label>
					<span class="fa fa-lock" ></span> Re-Enter Password </label>
				<input type="password" name="password2" placeholder="Re-Enter Password " required="true" id="myInput" />
				<div class="agile_label">
